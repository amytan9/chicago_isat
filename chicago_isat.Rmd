...
## should I add hhi as a variable here?- ASK

score_reg = lm(new_composite_16 ~ se_elem.x + policy_year + did.x + percent_bil, 
                data = master_2)

score_reg_2 = lm(new_composite_16 ~ se_elem.x + policy_year + did.x + hhi + percent_bil,
                data = master_2)
