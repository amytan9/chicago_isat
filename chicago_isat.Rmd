...
master_2$se_elem <- master_2$se_elem %>% replace_na(0)
```
...
stargazer(slope_test, slope_test1, slope_test2, slope_test3, 
          ...
          out="slope_test_by_race_2.html")
```

```{r}
# plot for how test scores changed before and after

test_score_se_plot <- ggplot(master_2, aes(year, new_composite_16, group = se_elem, color = se_elem)) +
  stat_summary(geom = 'line') +
   scale_x_continuous(breaks = 0:2100) +
    geom_vline(xintercept = 2011) +
    theme_minimal()
