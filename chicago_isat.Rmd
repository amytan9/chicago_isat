...
#composite scores
score_plot <- ggplot(master_2, aes(year, new_composite_16, group = se, color = se)) +
  stat_summary(geom = 'line') +
   scale_x_continuous(breaks = 0:2100) +
    geom_vline(xintercept = 2011) +
    theme_minimal() +
...
# math
score_math_plot <- ggplot(y, aes(year, math_14, group = se, color = se)) +
  stat_summary(geom = 'line') +
   scale_x_continuous(breaks = 0:2100) +
    geom_vline(xintercept = 2011) +
    theme_minimal() +
...
# reading
score_read_plot <- ggplot(y, aes(year, read_13, group = se, color = se)) +
  stat_summary(geom = 'line') +
   scale_x_continuous(breaks = 0:2100) +
    geom_vline(xintercept = 2011) +
    theme_minimal() +
